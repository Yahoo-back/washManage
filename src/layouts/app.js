...
const App = ({ children, dispatch, app, loading, location }) => {
  ...
  return (
    <div>
      ...
      <Layout className={classnames({ [styles.dark]: darkTheme })}>
        {!isNavbar && (
          <Sider trigger={null} collapsible collapsed={siderFold} width={235}>
            {siderProps.menu.length === 0 ? null : <MyLayout.Sider {...siderProps} />}
          </Sider>
        )}
        <Layout style={crrstyle.layout} id="mainContainer">
